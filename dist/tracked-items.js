(function () {
	...
	*/
	...
	var css = ".tracked-items_container__3QhwM {\n  height: 490px; }\n\n#tracked-items_back-btn__LJRw5 {\n  display: inline-block;\n  margin: 2px 0 0 8px;\n  position: fixed;\n  top: 95%; }\n\n/*# sourceMappingURL=data:application/json;base64, */";
	var styles = {"container":"tracked-items_container__3QhwM","back-btn":"tracked-items_back-btn__LJRw5"};
	styleInject(css);
	...
	var css$2 = "#items-list_tracked-items-list__22H6d {\n  padding: 2px 22px 0 4px;\n  width: 400px;\n  height: 426px;\n  overflow: auto;\n  list-style: none;\n  margin-top: 4px; }\n\n.items-list_item-container__3a6qH {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-wrap: nowrap;\n  line-height: 32px; }\n\n/*# sourceMappingURL=data:application/json;base64, */";
	...
	const Option = ({
	  ...
	  optionsName,
	  onChange
	}) => react.createElement("div", null, isChecked ? react.createElement("input", {
	  type: "radio",
	  name: optionsName,
	  id: id,
	  value: id,
	...
	class OptionsList extends react_2 {
	  render() {
	    return react.createElement("fieldset", null, react.createElement("legend", null, this.props.name), react.createElement(OptionsListContext.Provider, this.props, this.props.children));
	  }
	...
	class TrackedItems extends react_2 {
	  ...
	  shouldComponentUpdate(_, nextState) {
	    return isEqualWith_1(this.state.items, nextState.items, ({
	      timestamp: tsA
	    }, {
	      timestamp: tsB
	    }) => tsA === tsB);
	  ...
	  onTrackedItems(rawItems) {
	    return this.setState(state => _objectSpread({}, state, {
