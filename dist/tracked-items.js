(function () {
	...
	*/
	...
	var scheduleTracing_development = createCommonjsModule(function (module, exports) {
	 ...
	 * @returns {string} Returns the `toStringTag`.
	 */
	var getTag$1 = _baseGetTag;

	// Fallback for data views, maps, sets, and weak maps in IE 11 and promises in Node.js < 6.
	if ((_DataView && getTag$1(new _DataView(new ArrayBuffer(1))) != dataViewTag$2) ||
	    (_Map && getTag$1(new _Map) != mapTag$2) ||
	    (_Promise && getTag$1(_Promise.resolve()) != promiseTag) ||
	    (_Set && getTag$1(new _Set) != setTag$2) ||
	    (_WeakMap && getTag$1(new _WeakMap) != weakMapTag$1)) {
	...
	var css = ".tracked-items_container__3QhwM {\n  height: 550px;\n  min-width: 400px; }\n  .tracked-items_container__3QhwM .tracked-items_sub-header__29WIW .tracked-items_undo-button-container__Ne1cl {\n    float: right;\n    padding-top: 7px;\n    width: 20px;\n    height: 30px; }\n    .tracked-items_container__3QhwM .tracked-items_sub-header__29WIW .tracked-items_undo-button-container__Ne1cl.tracked-items_inactive__1U3Tf {\n      display: none; }\n\n#tracked-items_back-btn__LJRw5 {\n  display: inline-block;\n  margin: 16px 0 0 8px;\n  position: fixed;\n  top: 93%; }\n\n/*# sourceMappingURL=data:application/json;base64, */";
	var styles = {"container":"tracked-items_container__3QhwM","sub-header":"tracked-items_sub-header__29WIW","undo-button-container":"tracked-items_undo-button-container__Ne1cl","inactive":"tracked-items_inactive__1U3Tf","back-btn":"tracked-items_back-btn__LJRw5"};
	styleInject(css);

	var css$1 = ".icon-title_title-container__3futk {\n  display: flex;\n  flex-wrap: nowrap;\n  padding: 4px 8px 3px; }\n  .icon-title_title-container__3futk .icon-title_icon__2CzL_ {\n    width: 18px;\n    height: 18px; }\n    .icon-title_title-container__3futk .icon-title_icon__2CzL_.icon-title_shopping__55p7c {\n      background: url(\"data:image/svg+xml;charset=utf-8,%3Csvg viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'%3E %3Cpath d='m462 386c5.519531 0 10-4.480469 10-10s-4.480469-10-10-10-10 4.480469-10 10 4.480469 10 10 10zm0 0'/%3E %3Cpath d='m30 512h452c16.542969 0 30-13.457031 30-30v-372c0-5.523438-4.476562-10-10-10h-70c0-55.140625-44.859375-100-100-100-55.257812 0-100 44.699219-100 100h-76c-5.523438 0-10 4.476562-10 10v116h-136c-5.523438 0-10 4.476562-10 10v246c0 16.542969 13.457031 30 30 30zm-10-30v-36h232v36c0 5.515625-4.484375 10-10 10h-212c-5.515625 0-10-4.484375-10-10zm462 10h-211.71875c1.109375-3.128906 1.71875-6.492188 1.71875-10v-36h220v36c0 5.515625-4.484375 10-10 10zm-150-472c44.113281 0 80 35.886719 80 80h-160c0-44.210938 35.761719-80 80-80zm-166 100h66v46h-10c-5.523438 0-10 4.476562-10 10s4.476562 10 10 10h40c5.523438 0 10-4.476562 10-10s-4.476562-10-10-10h-10v-46h160v46h-10c-5.523438 0-10 4.476562-10 10s4.476562 10 10 10h40c5.523438 0 10-4.476562 10-10s-4.476562-10-10-10h-10v-46h60v306h-220v-190c0-5.523438-4.476562-10-10-10h-96zm86 126v180h-232v-180zm0 0'/%3E %3Cpath d='m76 306v20c0 33.148438 26.851562 60 60 60 33.085938 0 60-26.914062 60-60v-20c5.523438 0 10-4.476562 10-10s-4.476562-10-10-10h-20c-5.523438 0-10 4.476562-10 10s4.476562 10 10 10v20c0 22.054688-17.945312 40-40 40-22.09375 0-40-17.90625-40-40v-20c5.523438 0 10-4.476562 10-10s-4.476562-10-10-10h-20c-5.523438 0-10 4.476562-10 10s4.476562 10 10 10zm0 0'/%3E %3Cpath d='m462 346c5.523438 0 10-4.476562 10-10v-80c0-5.523438-4.476562-10-10-10s-10 4.476562-10 10v80c0 5.523438 4.476562 10 10 10zm0 0'/%3E %3C/svg%3E\") no-repeat; }\n  .icon-title_title-container__3futk .icon-title_title__2bW_J {\n    display: inline;\n    font-size: 18px;\n    margin: 0 0 0 14px; }\n\n/*# sourceMappingURL=data:application/json;base64, */";
	var styles$1 = {"title-container":"icon-title_title-container__3futk","icon":"icon-title_icon__2CzL_","shopping":"icon-title_shopping__55p7c","title":"icon-title_title__2bW_J"};
	styleInject(css$1);

	class IconTitle extends react_2 {
	  render() {
	    return react.createElement("div", {
	      className: styles$1["title-container"]
	    }, react.createElement("div", {
	      className: `${styles$1.icon} ${styles$1[this.props.icon]}`
	...
	var css$2 = "#items-list_tracked-items-list__22H6d {\n  padding: 2px 22px 0 4px;\n  height: 426px;\n  width: 400px;\n  overflow: auto;\n  list-style: none;\n  margin-top: 4px; }\n\n.items-list_item-container__3a6qH {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-wrap: nowrap;\n  line-height: 32px; }\n\n/*# sourceMappingURL=data:application/json;base64, */";
	var styles$2 = {"tracked-items-list":"items-list_tracked-items-list__22H6d","item-container":"items-list_item-container__3a6qH"};
	styleInject(css$2);

	var css$3 = ".item_item-icon-container__2mzdo {\n  width: 20px; }\n  .item_item-icon-container__2mzdo .item_item-icon__2-I-J {\n    padding-right: 6px;\n    width: 12px;\n    height: 12px; }\n\n.item_status-container__19NQs {\n  display: flex;\n  flex-wrap: nowrap;\n  width: 52px; }\n  .item_status-container__19NQs > div:not(:last-child) {\n    padding-right: 3px; }\n  .item_status-container__19NQs .item_item-watch__NkG_u {\n    background: url(\"data:image/svg+xml;charset=utf-8,%3Csvg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 512 512' style='enable-background:new 0 0 512 512;' xml:space='preserve'%3E %3Cg%3E %3Cg%3E %3Cpath d='M509.182,247.243c-1.142-1.593-28.465-39.467-72.822-77.761c-50.621-43.721-113.014-78.803-179.86-78.803 c-67.026,0-129.68,35.279-180.33,78.773C31.574,207.736,4,245.6,2.848,247.193c-3.797,5.26-3.797,12.354,0,17.614 C4,266.4,31.574,304.264,76.171,342.548c50.633,43.48,113.292,78.773,180.33,78.773c66.883,0,129.283-35.121,179.86-78.803 c44.356-38.294,71.679-76.168,72.822-77.761C512.939,259.517,512.939,252.482,509.182,247.243z M410.801,324.728 c-40.894,34.089-95.31,66.535-154.3,66.535c-63.794,0-122.358-38.655-160.241-71.088c-29.678-25.399-51.721-51.109-62.221-64.165 c10.48-13.022,32.456-38.611,62.15-64.062c41.703-35.742,98.629-71.211,160.313-71.211c63.774,0,122.047,38.645,159.71,71.058 c29.527,25.419,51.41,51.149,61.81,64.205C467.018,269.786,443.137,297.771,410.801,324.728z'/%3E %3C/g%3E %3C/g%3E %3Cg%3E %3Cg%3E %3Cpath d='
 {\n  display: flex;\n  align-items: center;\n  text-decoration: none; }\n  .item_item-label-container__2h3l1 .item_item-label__2PHqS {\n    font-size: 18px; }\n    .item_item-label-container__2h3l1 .item_item-label__2PHqS.item_price__1X5QB {\n      text-align: left;\n      width: 48px;\n      font-size: 22px;\n      padding-right: 8px;\n      align-self: flex-start; }\n  .item_item-label-container__2h3l1 .item_item-targetprice-container__3jtz1 {\n    padding-right: 14px;\n    width: 36px; }\n    .item_item-label-container__2h3l1 .item_item-targetprice-container__3jtz1 .item_item-label__2PHqS.item_target-price__WP1rD {\n      font-style: italic;\n      color: #b5a8a8; }\n  .item_item-label-container__2h3l1 .item_item-diffperc-container__1eDlq {\n    display: inline-flex;\n    width: 53px; }\n\n.item_item-icon__2-I-J,\n.item_item-watch__NkG_u,\n.item_item-notfound__2-zGC,\n.item_item-priceup__kh5Yo,\n.item_item-pricedown__8JHiX,\n.item_item-label__2PHqS.item_date__3vdh9 {\n  align-self: center; }\n\n/*# sourceMappingURL=data:application/json;base64, */";
	var styles$3 = {"item-icon-container":"item_item-icon-container__2mzdo","item-icon":"item_item-icon__2-I-J","status-container":"item_status-container__19NQs","item-watch":"item_item-watch__NkG_u","item-notfound":"item_item-notfound__2-zGC","item-priceup":"item_item-priceup__kh5Yo","item-pricedown":"item_item-pricedown__8JHiX","item-delete":"item_item-delete__3QDIB","item-label-container":"item_item-label-container__2h3l1","item-label":"item_item-label__2PHqS","price":"item_price__1X5QB","item-targetprice-container":"item_item-targetprice-container__3jtz1","target-price":"item_target-price__WP1rD","item-diffperc-container":"item_item-diffperc-container__1eDlq","date":"item_date__3vdh9"};
	styleInject(css$3);

	var css$4 = "#diff-percentage_icon__1avB_ {\n  width: 32px;\n  height: 32px; }\n\n/*# sourceMappingURL=data:application/json;base64, */";
	var styles$4 = {"icon":"diff-percentage_icon__1avB_"};
	styleInject(css$4);
	...
	class DiffPercentage extends react_2 {
	  render() {
	    const {
	      x,
	      fontSize,
	      percentage
	    } = getSvgConfig(this.props.value);
	    ...
	    }))), react.createElement("g", null, react.createElement("g", null, react.createElement("text", {
	      x: x,
	      y: "310",
	      fontFamily: "Verdana",
	      fontWeight: "bold",
	...
	const IconContainer = () => {
	  return react.createElement(ItemContext.Consumer, null, ({
	    faviconURL,
	    faviconAlt
	  }) => react.createElement("div", {
	    className: styles$3["item-icon-container"]
	  }, faviconURL && react.createElement("img", {
	    className: styles$3["item-icon"],
	    src: faviconURL,
	    title: faviconAlt
	  })));
	};
	...
	const StatusContainer = props => {
	  return react.createElement(ItemContext.Consumer, null, ({
	    ...
	    className: styles$3["status-container"]
	  }, isWatched && react.createElement("div", {
	    className: styles$3["item-watch"],
	    title: props.watchedTitle
	  }), isNotFound && react.createElement("div", {
	    className: styles$3["item-notfound"],
	    title: props.notFoundTitle
	  }), isHigher && react.createElement("div", {
	    className: styles$3["item-priceup"],
	    title: props.higherTitle
	  }), isLower && react.createElement("div", {
	    className: styles$3["item-pricedown"],
	    title: props.lowerTitle
	  })));
	};
	...
	const LabelContainer = props => {
	  return react.createElement(ItemContext.Consumer, null, ({
	    ...
	    className: styles$3["item-label-container"],
	    href: url,
	    title: url,
	    target: "_blank",
	    rel: "noopener noreferrer"
	  }, react.createElement("span", {
	    className: `${styles$3["item-label"]} ${styles$3.price}`
	  }, currentPrice), react.createElement("div", {
	    className: styles$3["item-targetprice-container"]
	  }, currentPrice !== targetPrice && react.createElement("span", {
	    className: `${styles$3["item-label"]} ${styles$3["target-price"]}`,
	    title: props.targetPriceTitle
	  }, targetPrice)), react.createElement("div", {
	    className: styles$3["item-diffperc-container"]
	  }, diffPercentage && (diffPercentage > 0 && react.createElement(DiffPercentage, {
	    backgroundColor: "red",
	    value: diffPercentage
	  }) || react.createElement(DiffPercentage, {
	    backgroundColor: "green",
	    value: diffPercentage
	  }))), react.createElement("span", {
	    className: `${styles$3["item-label"]} ${styles$3["date"]}`
	  }, dateTime)));
	};
	...
	const DeleteButton = props => {
	  ...
	  return react.createElement(ItemContext.Consumer, null, () => react.createElement("div", {
	    className: styles$3["item-delete"],
	    title: props.title,
	...
	class Item extends react_2 {
	  render() {
	    return react.createElement(ItemContext.Provider, this.props, this.props.children);
	  }

	}

	const createItemsList = (items, generateOnItemRemovedCallback) => items.map(item => react.createElement("li", {
	  key: item.timestamp,
	  className: styles$2["item-container"]
	}, react.createElement(Item, {
	  value: item
	}, react.createElement(IconContainer, null), react.createElement(StatusContainer, {
	  watchedTitle: "Watched - item price is being watched",
	  ...
	  targetPriceTitle: "Price the last time you marked it"
	}), react.createElement(DeleteButton, {
	  onItemRemoved: generateOnItemRemovedCallback(item.url),
	  title: "Remove item"
	}))));

	class ItemsList extends react_2 {
	  render() {
	    return react.createElement("ol", {
	      id: styles$2["tracked-items-list"]
	...
	var css$5 = ".options-list_options-fieldset__3DOY2 {\n  position: relative;\n  float: right;\n  border: 0; }\n  .options-list_options-fieldset__3DOY2 .options-list_legend__1yCvg {\n    position: absolute;\n    top: -12px;\n    right: calc(50% - 30px);\n    padding: 0 8px;\n    z-index: -1; }\n\n.options-list_option-container__2hFn2 {\n  display: inline-block;\n  border: 1px solid #000;\n  overflow: hidden; }\n  .options-list_option-container__2hFn2:nth-of-type(1) {\n    border-radius: 4px 0 0 4px; }\n  .options-list_option-container__2hFn2:nth-of-type(2) {\n    border-radius: 0 4px 4px 0; }\n  .options-list_option-container__2hFn2 .options-list_input__1h0by {\n    display: none; }\n    .options-list_option-container__2hFn2 .options-list_input__1h0by:checked + .options-list_label-container__2CYaT {\n      background-color: #878a91;\n      color: #FFF; }\n  .options-list_option-container__2hFn2 .options-list_label-container__2CYaT {\n    display: inline-block;\n    height: 22px;\n    width: 60px;\n    text-align: center; }\n    .options-list_option-container__2hFn2 .options-list_label-container__2CYaT .options-list_label__1l8NB {\n      display: block;\n      user-select: none;\n      line-height: 22px; }\n\n/*# sourceMappingURL=data:application/json;base64, */";
	var styles$5 = {"options-fieldset":"options-list_options-fieldset__3DOY2","legend":"options-list_legend__1yCvg","option-container":"options-list_option-container__2hFn2","input":"options-list_input__1h0by","label-container":"options-list_label-container__2CYaT","label":"options-list_label__1l8NB"};
	styleInject(css$5);
	...
	const Option = ({
	  ...
	  id,
	  isChecked
	}) => react.createElement(OptionsListContext.Consumer, null, ({
	  optionsName,
	  onChange
	}) => react.createElement("div", {
	  className: styles$5["option-container"]
	  ...
	  className: styles$5["label-container"]
	...
	class OptionsList extends react_2 {
	  render() {
	    return react.createElement("fieldset", {
	      className: styles$5["options-fieldset"]
	    }, react.createElement("legend", {
	      className: styles$5.legend
	    }, this.props.name), react.createElement(OptionsListContext.Provider, this.props, this.props.children));
	  }
	...
	var css$6 = ".icon-button_icon__Adcps {\n  height: 16px;\n  width: 16px;\n  cursor: pointer; }\n  .icon-button_icon__Adcps.icon-button_undo__3rrEt {\n    background: url(\"data:image/svg+xml;charset=utf-8,%3Csvg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 216.318 216.318' style='enable-background:new 0 0 216.318 216.318;' xml:space='preserve'%3E %3Cpath d='M118.913,22.172V0L45.295,43.154l73.617,43.155V62.604c27,5.108,46.549,28.418,46.549,56.331 c0,31.641-25.659,57.383-57.3,57.383s-57.341-25.742-57.341-57.383c0-8.319,1.756-16.334,5.179-23.821L19.632,78.483 c-5.825,12.743-8.774,26.354-8.774,40.452c0,53.697,43.688,97.383,97.385,97.383s97.218-43.686,97.218-97.383 C205.461,68.939,167.913,27.629,118.913,22.172z'/%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3Cg%3E %3C/g%3E %3C/svg%3E\") no-repeat; }\n\n/*# sourceMappingURL=data:application/json;base64, */";
	var styles$6 = {"icon":"icon-button_icon__Adcps","undo":"icon-button_undo__3rrEt"};
	styleInject(css$6);

	class IconButton extends react_2 {
	  render() {
	    return react.createElement("div", {
	      className: `${styles$6.icon} ${styles$6[this.props.icon]} ${styles$6[this.props.state]}`,
	...
	function onOpenTrackedItemsResponse({
	  isUndoStatusActive
	}) {
	  this.setState({
	...
	function onUndoAttemptResponse({
	  isUndoStatusActive
	}) {
	  this.updateTrackedItems();
	  this.setState({
	...
	class TrackedItems extends react_2 {
	  constructor(props) {
	    super(props);
	    this.state = {
	      items: [],
	  ...
	  shouldComponentUpdate(_, nextState) {
	    return this.state.items.length !== nextState.items.length || isEqualWith_1(this.state.items, nextState.items, ({
	      timestamp: tsA,
	      statuses: stA
	    }, {
	      timestamp: tsB,
	      statuses: stB
	    }) => tsA === tsB && isEqual_1(stA, stB)) || this.state.undoStatus !== nextState.undoStatus;
	  }
	  ...
	  render() {
	    return react.createElement("section", {
	      ...
	      className: `${styles["undo-button-container"]} ${styles[this.state.undoStatus]}`
	    }, react.createElement(IconButton, {
	      icon: "undo",
	      title: "Undo remove item",
	      onClick: this.generateOnUndoRemoveClickCallback()
	    })), this.state.items.length > 0 && react.createElement(OptionsList, {
	      name: "Sort by",
	      value: {
	        optionsName: "sortItems",
	      ...
	      name: "Price",
	      id: CURRENT_PRICE
	    }))), this.state.items.length > 0 && react.createElement(ItemsList, {
	      items: this.state.items,
	      generateOnItemRemovedCallback: this.generateOnItemRemovedCallback
	    }) || react.createElement("h4", null, "No items currently being tracked."), react.createElement(BackButton, {
	      href: "popup.html"
	    }));
	  }
	  ...
	  onTrackedItems(rawItems) {
	    return this.setState({
	      items: rawItems.map(item => _objectSpread({}, item, {
	...
	function bootstrap() {
	  reactDom_1(react_4(TrackedItems), document.getElementById("tracked-items-page"));
	}
