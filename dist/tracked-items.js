  ...
  */
  ...
  const LabelContainer = props => {
    return react.createElement(ItemContext.Consumer, null, ({
      ...
      className: styles$2["item-label price"]
    }, currentPrice), react.createElement("div", {
      className: styles$2["item-targetprice-container"]
    }, targetPrice), react.createElement("div", {
      className: "item-diffperc-container"
    }, diffPercentage && ( // TODO: new component <diff SVG>
    // <DiffPercentage />
    diffPercentage > 0 && react.createElement("div", {
      className: styles$2["item-diffperc win"]
    }) || react.createElement("div", {
      className: styles$2["item-diffperc lose"]
    }))), react.createElement("span", {
      className: "item-label date"
    }, dateTime)));
  };
  ...
  const mapItemsList = items => items.map(item => react.createElement("li", {
    key: item.timestamp,
  ...
  const REFRESH_INTERVAL$1 = 14000;
  ...
  function setupUpdateTrackedItems() {
    ...
    setInterval(updateTrackedItems$1, REFRESH_INTERVAL$1);
  }
