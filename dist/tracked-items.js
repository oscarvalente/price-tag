  ...
  */
  ...
  const IconContainer = () => {
    return react.createElement(ItemContext.Consumer, null, ({
      ...
      className: styles$2["item-icon-container"]
    }, faviconURL && react.createElement("img", {
      className: styles$2["item-icon"],
      src: faviconURL,
      title: faviconAlt
    })));
  };
  ...
  const LabelContainer = props => {
    return react.createElement(ItemContext.Consumer, null, ({
      ...
      className: styles$2["item-label-container"],
      href: url,
      title: url,
      target: "_blank"
    }, react.createElement("span", {
      className: `${styles$2["item-label"]} ${styles$2.price}`
    }, currentPrice), react.createElement("div", {
      className: styles$2["item-targetprice-container"]
    }, react.createElement("span", {
      className: `${styles$2["item-label"]} ${styles$2["target-price"]}`,
      title: props.targetPriceTitle
    }, targetPrice)), react.createElement("div", {
      className: styles$2["item-diffperc-container"]
      ...
      className: `${styles$2["item-label"]} ${styles$2["date"]}`
    }, dateTime)));
  };
  ...
  const DeleteButton = props => {
    return react.createElement(ItemContext.Consumer, null, ({
      ...
      className: styles$2["item-delete"],
  ...
  const mapItemsList = (items, onItemRemoved) => items.map(item => react.createElement("li", {
    key: item.timestamp,
    className: styles$1["item-container"]
  ...
  class ItemsList extends react_2 {
    render() {
      return react.createElement("ol", {
        id: styles$1["tracked-items-list"]
  ...
  class TrackedItems extends react_2 {
    ...
    render() {
      return react.createElement("section", {
        ...
        onItemRemoved: this.updateTrackedItems
      }));
    }
  ...
  function onTrackedItems(rawItems) {
    const trackedItems = rawItems.map(item => _objectSpread({}, item, {
      dateTime: formatDate$1(item.timestamp),
      isWatched: item.statuses.includes(ITEM_STATUS$1.WATCHED),
      isNotFound: item.statuses.includes(ITEM_STATUS$1.NOT_FOUND),
      isHigher: item.statuses.includes(ITEM_STATUS$1.INCREASED),
      isLower: item.statuses.includes(ITEM_STATUS$1.DECREASED),
      diffPercBackground: item.diffPercentage && item.diffPercentage > 0 ? "red" : "green"
    }));
  ...
  function addRemoveEvents(selection) {
    ...
    for (let elem in deleteElements) {
      if (deleteElements.hasOwnProperty(elem)) {
        ...
        element.onclick = removeItem$1.bind(null, url, element.parentElement);
      }
    }
  }

  function removeItem$1(url, listItemElement) {
    chrome.runtime.sendMessage({
      type: "TRACKED_ITEMS.UNFOLLOW",
      payload: {
        url
  ...
  function setupUpdateTrackedItems() {
    updateTrackedItems$1(); // TEMP: uncomment to refresh
  ...
  function bootstrap() {
    ...
    reactDom_1(react_5(TrackedItems), document.getElementById('tracked-items-page'));
  }
