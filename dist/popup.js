(function () {
	...
	*/
	...
	var css = ".popup-app_tracking-container__2kg83 {\n}\n";
	styleInject(css);
	...
	function updatePriceUpdateButton$1(buttonEnabled) {
	  if (buttonEnabled === true) {
	...
	function setPendingPriceUpdate$1() {
