(function () {
  ...
  function buildSaveConfirmationPayload(currentURL, similarURL) {
    return {
      ...
      message: "It appears that the item URL you're trying to save:<br>" + `<i><a href="${currentURL}">${currentURL}</a></i><br>` + "is pretty similar to<br>" + `<i><a href="${similarURL}">${similarURL}</a></i><br><br>` + "Since your choice will affect the way items are tracked in this site futurely,<br>please help us helping you by choosing carefully one of the following options:",
  ...
  function buildURLConfirmationPayload(canonicalURL, browserURL, domain) {
    return {
      ...
      message: `<u>${domain}</u> says that a more accurate URL for this item would be:<br>` + `<i><a href="${canonicalURL}">${canonicalURL}</a></i><br>` + "If this is correct, we recommend you to follow it.<br><br>" + "<b>However</b> you can still opt to choose following the current browser URL:<br>" + `<i><a href="${browserURL}">${browserURL}</a></i><br><br>` + "Since your choice will affect the way items are tracked in this site futurely,<br>please help us helping you by choosing carefully one of the following options:",
